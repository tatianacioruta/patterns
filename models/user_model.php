...
class User_model extends Model
{
    ...
    public function get_one_by_cond($cond = array(), $colums)
    {
        $join = array();

        return $this->db->select_one($this->_table, $cond, $join, $colums);
    }
    public function get_all($conditions = array(), $join = array(), $order = array(), $limit = false, $columns = '*')
    {
